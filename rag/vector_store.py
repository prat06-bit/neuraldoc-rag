"""Vector store layer using ChromaDB + sentence-transformers."""
...
class VectorStore:
    ...
    def similarity_search(self, query: str, k: int | None = None) -> list[ScoredChunk]:
        ...
        for text, meta, dist in zip(docs, metas, dists):
            ...
            scored.append(ScoredChunk(chunk=self._deserialise_chunk(text, meta), score=score))
    ...
    def _serialise_metadata(chunk: DocumentChunk) -> dict[str, Any]:
        return {
            ...
            "breadcrumb_path": json.dumps(chunk.metadata.breadcrumb_path),
        }
    ...
    def _deserialise_chunk(text: str, meta: dict[str, Any]) -> DocumentChunk:
        return DocumentChunk(
            ...
            metadata=ChunkMetadata(
                ...
                breadcrumb_path=json.loads(meta.get("breadcrumb_path", "[]")),
            ),
        )